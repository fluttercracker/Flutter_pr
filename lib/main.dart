...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void showNoteDialog({String? id, String? title, String? note, String? category}) {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                      content: Text(
                          id == null ? 'Note added successfully' : 'Note updated successfully')),
                );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Try adding or searching for a note.',
                            style: TextStyle(
                                fontSize: 16, color: Colors.deepPurple.shade200)),
                      ],
                    ),
                  );
                }
